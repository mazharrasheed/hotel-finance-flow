              ...
              {projectStats.map((stat) => (
                ...
                >
                  ...
                  <div className="relative h-64 w-full bg-white/40 rounded-3xl border border-slate-100 p-6 flex flex-col group-hover:bg-white group-hover:shadow-lg group-hover:border-indigo-100 transition-all duration-300 backdrop-blur-sm">
                    ...
                    {/* Values Overlay */}
                    <div className="absolute top-4 left-6 flex flex-col gap-0.5 z-10 opacity-40 group-hover:opacity-100 transition-opacity">
                    ...
                    <div className="flex-1 flex items-end justify-center gap-4 px-2">
                      ...
                      <div className="flex-1 max-w-[32px] h-full flex items-end">
                        <div 
                          className="w-full bg-gradient-to-t from-emerald-500 to-emerald-400 rounded-t-lg transition-all duration-1000 ease-out shadow-[0_-4px_10px_rgba(16,185,129,0.15)] group-hover:shadow-[0_-6px_15px_rgba(16,185,129,0.3)]"
                      ...
                      <div className="flex-1 max-w-[32px] h-full flex items-end">
                        <div 
                          className="w-full bg-gradient-to-t from-rose-500 to-rose-400 rounded-t-lg transition-all duration-1000 ease-out shadow-[0_-4px_10px_rgba(244,63,94,0.15)] group-hover:shadow-[0_-6px_15px_rgba(244,63,94,0.3)]"
